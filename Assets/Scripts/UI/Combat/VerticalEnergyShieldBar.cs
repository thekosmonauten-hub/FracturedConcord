...
/// <summary>
/// Vertical energy shield bar that overlays on top of health bar.
/// Energy shield provides additional protection before health is damaged.
/// </summary>
[RequireComponent(typeof(Image))]
public class VerticalEnergyShieldBar : MonoBehaviour
{
    [Header("Bar Configuration")]
    [SerializeField] private Image fillImage;
    
    [Header("Colors")]
    [SerializeField] private Color barColor = new Color(0.5f, 0.8f, 1f, 0.6f); // Light blue with semi-transparency
    ...
    [SerializeField] private Color damageFlashColor = Color.cyan;
    ...
    private void UpdateColor(float fillAmount)
    {
        ...
        if (useGradient && shieldGradient != null)
        {
            // Use gradient
            fillImage.color = shieldGradient.Evaluate(fillAmount);
        }
        else
        {
            // Use solid color
