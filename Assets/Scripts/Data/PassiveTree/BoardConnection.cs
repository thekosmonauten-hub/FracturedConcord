...
namespace PassiveTree
{
    ...
    public class BoardConnection
    {
        ...
        public string boardAId;              // First board in connection
        public string boardBId;              // Second board in connection
        
        [Header("Connection Type")]
        public ConnectionType connectionType = ConnectionType.Straight;
        ...
        {
            this.id = $"{extensionPointId}_{boardId}";
            this.extensionPointId = extensionPointId;
            this.boardId = boardId;
            this.boardAId = extensionPointId;
            this.boardBId = boardId;
            this.connectionType = ConnectionType.Straight;
        ...
        {
            return $"BoardConnection '{id}' - {extensionPointId} -> {boardId} ({connectionType})";
        }
    }
